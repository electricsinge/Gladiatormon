var background = "";
var buttonAttacks = [attacks[0], attacks[1], attacks[2]];
var options = ["Attack", "Defend", "Spare"];
var turn = true;
var attackonbuttons = false;
var attacking = false;
var buttonText = {
    _text: [],
    get text() {
    ...
    set text(value) {
        this._text = value;
        for (var i = 0; i < document.getElementById('btn-group').querySelectorAll('button').length; i++) {
